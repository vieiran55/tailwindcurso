import logo1 from "../../image/logo-tailwind.png";
import logo from "../../image/icone-mergulhador.svg";

export default function Home() {
  return (
    <>

      {/* <div className="bg-white flex flex-col lg:flex-row justify-center items-center w-4/5 mx-auto my-40 p-12 shadow-2xl opacity-50">
        <img  className="w-2/5 lg:w-1/5" src={logo} alt="Logo Tailwind CSS" />
        <h1 className="text-4xl lg:text-6xl font-black text-center">Olá Tailwind CSS!</h1>
        <img  className="w-2/5 lg:w-1/5" src={logo} alt="Logo Tailwind CSS" />
      </div>
      <div className="justify-center items-center w-4/5 mx-auto my-40 p-12 shadow-2xl bg-gradient-to-r from-red-800 to-[#000000]">
        <h1 className="text-4xl text-white font-bold font-vast">Antonio</h1>
        <h2 className="text-lg text-white">Desenvolvedor Front-End</h2>
      </div> */}
      ...
      <main className="flex px-6 drop-shadow-2xl lg:w-3/4">
        ...
        <section className="bg-white p-10 gap-6 flex flex-col rounded-lg lg:w-1/2 justify-center lg:rounded-l-none">
          <div className="self-center relative group">
            <svg
              className="fill-azul-escuro absolute top-0 left-1 opacity-0 group-hover:opacity-100 group-hover:animate-ping"
              width="35"
              height="20"
              viewBox="0 0 44 20"
              fill="none"
            ...
            <svg
              className="w-12 h-12 fill-azul-claro stroke-azul-escuro group-hover:animate-sino"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
          ...
          <form>
            ...
            />
            <button className="text-white bg-azul-escuro w-full py-2 rounded-full shadow-2xl hover:bg-azul-hover duration-150" type="button">
              Inscreva-se
            </button>
          </form>
        </section>
